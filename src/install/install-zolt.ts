...
import { downloadArchive, type Fetch } from './download.js';
...
export async function installZolt(
    ...
    try {
        ...
        if (download.sha256 !== release.sha256) {
            throw actionError(
                'ZOLT-INSTALL-006',
                `Downloaded Zolt archive failed SHA-256 verification. Expected ${release.sha256}; actual ${download.sha256}.`,
            );
        }
