...
const ISO_CONTROL = /[\u0000-\u001F\u007F-\u009F]/u;
const JAVA_BLANK = /^[\u0009-\u000D\u001C-\u0020\u1680\u2000-\u2006\u2008-\u200A\u2028\u2029\u205F\u3000]+$/u;
export function createZoltTargetId(identity) {
...
export function requireMatchingZoltTargetId(targetId, identity, label) {
...
export function canonicalTargetPath(value, label) {
...
export function canonicalTargetText(value, label) {
    if (value === ''
...
function updateField(digest, value) {
