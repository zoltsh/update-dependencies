...
export async function runAction(dependencies = {}) {
    ...
    try {
        ...
        if (!inputs.dryRun) {
            throw actionError('ZOLT-WRITE-001', 'This implementation batch is planning-only. Set dry-run to true until Zolt publishes its canonical exact-target update contract.');
        }
