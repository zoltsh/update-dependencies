...
export function renderPullRequestPreview(target, branchGeneration = '0'.repeat(40)) {
...
export function renderManagedPullRequest(target, baseSha, managedHeadSha, branchGeneration = baseSha) {
    ...
    return renderPullRequest(target, marker, 'Zolt supplied the canonical target identity and manifest/root-lock paths. The isolated exact update and locked offline verification completed before this branch was published.', branchGeneration);
}
function renderPullRequest(target, marker, verification, branchGeneration) {
...
export function managedBranch(target, branchGeneration) {
